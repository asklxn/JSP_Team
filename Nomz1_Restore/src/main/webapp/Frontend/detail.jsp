...
<%
  ...
  String imageUrl = product.getImageUrl(); // e.g. "uploads/xxx.jpg"
%>
<!DOCTYPE html>
<html lang="ko">
<head>
  ...
  <style>
    ...
    .section_1 { width: 1200px; height: 100vh; margin: 0 auto; padding-top: 60px; display: flex; justify-content: space-between; align-items: center; overflow: visible; }
    ...
    .item_wrap { bottom: 70px; display: flex; flex-direction: column; justify-content: space-between; width: 100%; height: 120px; background-color: #dce5ed; margin-top: 120px; padding: 20px; }
    .price_wrap { width: 100%; display: flex; justify-content: space-between; align-items: center; }
    .item_text_2 { font-size: 18px; }
    .count_wrap { width: 100px; height: 27px; border: 1px solid #0b1838; display: flex; justify-content: space-between; align-items: center; user-select: none; overflow: hidden; }
    .minus, .plus { width: 25px; height: 25px; font-size: 14px; text-align: center; line-height: 25px; font-weight: 300; cursor: pointer; overflow: hidden; }
    .item_count { width: 50px; height: 27px; text-align: center; font-size: 14px; border: 1px solid #0b1838; line-height: 27px; }
    .total { width: 90px; text-align: right; font-size: 14px; }
    .btn_wrap { display: flex; justify-content: space-between; align-items: center; width: 100%; height: 50px; margin-top: 20px; }
    .cart_btn, .buy_btn { width: 270px; height: 100%; background-color: #0b1838; color: #fffdf9; font-size: 20px; text-align: center; line-height: 50px; cursor: pointer; user-select: none; }
    .title { font-size: 35px; text-align: center; margin: 30px; }
    .section_2 { width: 100%; padding: 100px; text-align: center; }
  </style>
</head>
<body>
  <header>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
      ...
      buyBtn.addEventListener("click", () => {
        alert("구매가 완료되었습니다.");
        location.href = "<%=request.getContextPath()%>/productList";
      });
